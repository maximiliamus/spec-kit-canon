...
This preview must list every current `ACCEPTED` entry that `/speckit.canon.vibecode-drift-canonize` would apply from the draft as it exists in this analysis pass.

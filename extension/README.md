...
It adds the namespaced `speckit.canon.*` commands used for canon drift repair
and vibecoding workflows. For the full canon-driven core workflow, install the
...
See the repository root `README.md` for the combined extension + preset
workflow guide.

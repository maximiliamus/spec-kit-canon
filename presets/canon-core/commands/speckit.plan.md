...
scripts:
  sh: bash .specify/scripts/bash/setup-plan.sh --json
  ps: pwsh -NoProfile -File .specify/scripts/powershell/setup-plan.ps1 -Json
agent_scripts:
  sh: bash .specify/scripts/bash/update-agent-context.sh __AGENT__
